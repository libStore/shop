...
<title>AppOil安装向导(三)</title>
<link rel="stylesheet" href="css/install.css" />
<script type='text/javascript' src='javascript/jquery-1.4.4.min.js'></script>
</head>
<body>
<div class="container">
	<div class="head"><img src="images/logo.gif" width="354" height="53" alt="AppOil安装向导" /></div>
					...
					<div class="gray_box">
						<div class="box">
							<table class="form_table">
								...
								<tr>
									<th>数据库名称</th>
									<td><input class="gray" type="text" name='db_name' value="shop"/><br/><label
											class="error" id='db_name_label' style='display:none'><img
												src="images/failed.gif" width="16" height="15"/>请填写正确的数据库名称</label></td>
								</tr>
								<tr>
									<th>账户</th>
									<td><input class="gray" type="text" name='db_user' value="root"/></td>
								</tr>
								<tr>
									<th>密码</th>
							...
							<table class="form_table">
								...
								<tr>
									<th>密码</th>
									<td>
										<input class="gray" type="password" name='admin_pwd' value="111aaa"/><br/>
								...
								<tr>
									<th>再次确认</th>
									<td>
										<input class="gray" type="password" name='admin_repwd' value="111aaa"/><br/>
	...
	<div class="foot"><a href="http://www.appoil.com">关于我们</a>|<a href="http://www.appoil.com">官方网站</a>|<a href="http://www.appoil.com">联系我们</a>|<a href="">©2005-2015</a></div>
</div>
