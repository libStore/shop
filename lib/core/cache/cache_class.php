...
class ICache
{
	...
	public function __construct($cacheType = '')
	{
		...
		$this->expire = isset(Web::$app->config['cache']['expire']) ? Web::$app->config['cache']['expire'] : $this->expire;
		$this->timeout = isset(Web::$app->config['cache']['timeout']) ? Web::$app->config['cache']['timeout'] : $this->timeout;
