...
class IFileCache implements ICacheInte
{
	...
	{
		$this->cachePath = isset(Web::$app->config['cache']['path']) ? Web::$app->config['cache']['path'] : $this->cachePath;
		$this->cacheExt = isset(Web::$app->config['cache']['ext']) ? Web::$app->config['cache']['ext'] : $this->cacheExt;
	}
