...
class ITime
{
	...
	/**
	 * @brief  根据输入的时间返回时间戳
	 * @param  $time String 输入的时间，格式为年-月-日 时:分：秒,如2014-01-01 00:00:00
	 ...
	 * @param $first_time  String 第一个时间 格式为英文时间格式，如2014-01-01 00:00:00
	 * @param $second_time String 第二个时间 格式为英文时间格式，如2014-01-01 00:00:00
