...
{
	private $dbo      = null;
	private $sql      = array('table'=>'','fields'=>'*','where'=>'','join'=>'','group'=>'','having'=>'','order'=>'','limit'=>'limit 1000','distinct'=>'');
	private $tablePre = '';
	public $paging    = null;
    /**
     * @brief 构造函数
	...
	{
		$this->tablePre = isset(Web::$app->config['DB']['tablePre']) ? Web::$app->config['DB']['tablePre'] : '';
		$this->table = $name;
