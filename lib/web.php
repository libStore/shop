 ...
 */
//内核路径
defined('WEB_PATH') or define('WEB_PATH', dirname(__file__) . DIRECTORY_SEPARATOR);
/**
 * @brief Web内核的基类
 * @class Web
 */
class Web
{
	...
	public static function autoload($className)
	{
		...
		{
			include(WEB_PATH . self::$_coreClasses[$className]);
			return true;
		}
	...
	public static $_coreClasses = array(
		...
		'WebApplication' => 'core/webapplication_class.php',
