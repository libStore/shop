<?php
/**
 * @copyright (c) 2014 www.appoil.com
 * @file CheckRight.php
 * @brief 权限校验类,包括admin(管理员),seller(商户),user(注册用户)
 * @author Jason
...
class CheckRights extends IInterceptorBase
{
	...
	{
		$controllerInstance = Web::$app->getController();
